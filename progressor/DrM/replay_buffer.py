...
class ReplayBufferStorage:
    ...
    def add(self, time_step, init_frame = None, goal_frame = None):
        for spec in self._data_specs:
            value = time_step[spec.name]
            if np.isscalar(value):
                value = np.full(spec.shape, value, spec.dtype)
            #assert spec.shape == value.shape and spec.dtype == value.dtype   modified
        ...
        if time_step.last():
            ...
            episode['init_frame'] = init_frame
            episode['goal_frame'] = goal_frame
            self._current_episode = defaultdict(list)
...
class ReplayBuffer(IterableDataset):
    ...
    def _sample(self):
        ...
        if 'observation_sensor' in episode.keys():
            ...
            return (obs, action, reward, discount, next_obs, init_frame, goal_frame)
